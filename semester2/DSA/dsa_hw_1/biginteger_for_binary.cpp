...
int BigInteger::howbig() const{
	int count = 1000;
//	cout << "in howbig() *this = " << *this << "\n";
	while(count > 0 && digits[count-1] == 0)
		count--;
//	cout << "before return count = " << count << "\n";
	return count;
}
...
//	cout << "before for loop chgform = " << chgform << ", out = " << out << ", *this = " << *this << "\n";
	for(int i = 0; i < realsize; i++)
                for(int j = 0; j < chgform.realsize; j++){
//			cout << "out = " << out << "\n";
                        out.digits[i+j] += digits[i] * chgform.digits[0];
			assert(out.digits[i+j] >= 0);
		}
//        cout << "165out = " << out << " ";
	...
	realsize = out.howbig();
//	cout << "after for realsize = " << realsize << "\n";
//	out.realsize = out.howbig();
//        cout << "malloc-176" << "\n";
        delete [] digits;
        size = 1000;
